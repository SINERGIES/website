...
<section class="page-hero">
  <h1>Plan du site</h1>
  <p>Accès rapide aux principales pages et sections du site.</p>
</section>

<section class="page-content sitemap-page">
  <h2>Pages principales</h2>
  <ul>
    <li><a href="{{ '/#accueil' | relative_url }}">Accueil</a></li>
    <li><a href="{{ '/#axes' | relative_url }}">Axes</a></li>
    ...
    <li><a href="{{ '/accessibilite/' | relative_url }}">Accessibilité</a></li>
  </ul>
</section>
